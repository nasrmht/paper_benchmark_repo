...
C_FI  = {0: "#417C03", 1: "#417C01", 2: "#417C05", 3: "#417C09"} #{0: "#74c476", 1: "#84ca85", 2: "#94d195", 3: "#a4d8a5"}
M_FI  = "^"
LS_FI = ":"
LW_FI = 1.3
MS_FI = 3
...
C_FM  = {0: "#5e239d", 1: "#5a239d", 2: "#5b239d", 3: "#5c 239d"} #{0: "#9E9AC8", 1: "#ABA6D2", 2: "#B8B3DB", 3: "#C5C0E4"}
M_FM  = "D"
LS_FM = "-."
LW_FM = 1.3
MS_FM = 3
...
def load_all_data(
    ...
    """
    import pickle
    pkl_file = "plot_cfd_rrmse_data.pkl"
    if os.path.exists(pkl_file):
        print(f"Loading cached data from {pkl_file} ...")
        with open(pkl_file, "rb") as f:
            saved = pickle.load(f)
        return saved["agg_by_n"], saved["data"], saved["n_label"]
    ...
    with open(pkl_file, "wb") as f:
        pickle.dump({"agg_by_n": agg_by_n, "data": data, "n_label": n_label}, f)
...
def make_all_fields_figure_nozoom(
    ...
    _add_grouped_legend(fig, fs, variant_filter, y_anchor=-0.18)
